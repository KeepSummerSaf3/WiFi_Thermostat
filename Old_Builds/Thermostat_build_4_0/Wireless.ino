...
#define ICAO "station: KAAA"
//USED FOR CURRENT METAR INFORMATION AT NEW ORLEANS LOUIS ARMSTRONG
char url_metar_server[] = "/home/metar_output/KAAA.txt";
...
//          Serial.print("Pressure: ");
//          if(tmp[93] == ' ' || tmp[93] == '.')
//            metar_table[0].pressure = (tmp[90] - '0')*100 + (tmp[91] - '0')*10 + (tmp[92] - '0');
//          else
//            metar_table[0].pressure = (tmp[90] - '0')*1000 + (tmp[91] - '0')*100 + (tmp[92] - '0')*10 + (tmp[93] - '0');
...
void wireless_loop(){
  ...
  if(metar_server_cnt > 150 && !(METAR_req.isActive()))
  {
      pass = 0;
